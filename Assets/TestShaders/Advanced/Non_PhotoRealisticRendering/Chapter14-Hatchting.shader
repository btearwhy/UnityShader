Shader "Unlit/Chapter14-Hatching"
{
    Properties
    {
        ...
        _TileFactor("Till Factor", Float) = 1
        ...
        { 
           ...
           v2f vert(a2v v)
           {
               ...
               else if (hatchFactor > 4.0)
               {
                   ...
                   o.hatchWeight1.y = 1.0 - o.hatchWeight0.x;
               }
           ...
           fixed4 frag(v2f i):SV_Target{
               ...
               fixed4 hatchTex3 = tex2D(_Hatch3, i.uv) * i.hatchWeight0.x;
               fixed4 hatchTex4 = tex2D(_Hatch4, i.uv) * i.hatchWeight0.y;
               fixed4 hatchTex5 = tex2D(_Hatch5, i.uv) * i.hatchWeight0.z;
